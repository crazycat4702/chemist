...
public class NatriumBlock extends ChemistryModElements.ModElement {
	@ObjectHolder("chemistry:natrium")
	public static final Block block = null;

	public NatriumBlock(ChemistryModElements instance) {
		super(instance, 39);
	}
