...
public class HeliumBlock extends ChemistryModElements.ModElement {
	@ObjectHolder("chemistry:helium")
	public static final Block block = null;
	public HeliumBlock(ChemistryModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("chemistry:helium_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("helium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("chemistry:helium"), configuredFeature);
		}
	}
	@SubscribeEvent
