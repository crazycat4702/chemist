...
public class HydrogenBlock extends ChemistryModElements.ModElement {
	@ObjectHolder("chemistry:hydrogen")
	public static final Block block = null;

	public HydrogenBlock(ChemistryModElements instance) {
		super(instance, 4);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("chemistry:hydrogen_match"), () -> CustomRuleTest.codec);
			feature = new OreFeature(OreFeatureConfig.CODEC) {
				@Override
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					RegistryKey<World> dimensionType = world.getWorld().getDimensionKey();
					boolean dimensionCriteria = false;
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("chemistry:chemist_land")))
			...
			event.getRegistry().register(feature.setRegistryName("hydrogen"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("chemistry:hydrogen"), configuredFeature);
		}
	}
