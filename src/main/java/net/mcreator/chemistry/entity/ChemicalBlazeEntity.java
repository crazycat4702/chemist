...
package net.mcreator.chemistry.entity;
...
import net.mcreator.chemistry.procedures.ChemicalBlazeOnEntityTickUpdateProcedure;
...
public class ChemicalBlazeEntity extends ChemistryModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("chemical_blaze_spawn_egg"));
	}
	...
	public static class CustomEntity extends BlazeEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FuelItem.block));
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(RadioactiveParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
