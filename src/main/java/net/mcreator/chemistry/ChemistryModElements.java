...
public class ChemistryModElements {
	...
	public ChemistryModElements() {
		...
		try {
			ModFileScanData modFileInfo = ModList.get().getModFileById("chemistry").getFile().getScanResult();
			Set<ModFileScanData.AnnotationData> annotations = modFileInfo.getAnnotations();
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					Class<?> clazz = Class.forName(annotationData.getClassType().getClassName());
					if (clazz.getSuperclass() == ChemistryModElements.ModElement.class)
						elements.add((ChemistryModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(ChemistryModElements.ModElement::initElements);
	}
